package sin.glouds.test.file.check;
...
//		System.out.println(checkFiles(file));
		System.out.println(new Gson().toJson(getFileInfo(file)).length());
//		System.out.println(new Gson().toJson(getFileInfo(file)));
...
class FileInfo implements Serializable {
	...
	public String toString() {
		return "FileInfo [isDirectory=" + isDirectory + ", size=" + size + ", name=" + name + ", path=" + path
				+ ", fileInfos=" + fileInfos + "]";
	}
