...
public class Specification {
	...
	public String toString() {
		return "Specification [id=" + id + ", code=" + code + ", name=" + name + ", length=" + length + ", width="
				+ width + ", height=" + height + ", status=" + status + ", createBy=" + createBy + ", createDate="
				+ createDate + ", updateBy=" + updateBy + ", updateDate=" + updateDate + ", remarks=" + remarks
				+ ", delFlag=" + delFlag + ", weight=" + weight + ", isbatchprocess=" + isbatchprocess + ", category="
				+ category + "]";
	}
